...
database schema automatically on startup. This last is configured for adding
...
keys since a Job deletion may imply several delete by cascade.
...
system since these last may hurt performances.
